...
/**
 * Lista de propostas apresentadas ao cliente
...
<div class="section-header">
  <div>
    <h1 class="section-title"><?php echo View::e(I18n::t('sidebar_cli.propostas')); ?></h1>
    <p class="section-subtitle">Propostas apresentadas para suas demandas</p>
  </div>
</div>
