...
/**
 * Lista de conversas do parceiro
 * Variáveis: $conversas (array)
 */
?>
<div class="section-header">
  <div>
    <h1 class="section-title"><?php echo View::e(I18n::t('sidebar_par.mensagens')); ?></h1>
    <p class="section-subtitle">Suas conversas com a equipe Lexus</p>
  </div>
  <a href="/parceiro/mensagens/nova" class="btn btn-primary"><?php echo View::e(I18n::t('geral.novo')); ?> Mensagem</a>
</div>
...
<?php else: ?>
  <div style="display:flex;flex-direction:column;gap:1px">
    ...
    <a href="/parceiro/mensagens/<?php echo View::e((string)$c['id']); ?>" class="card" style="text-decoration:none;display:flex;justify-content:space-between;align-items:center;padding:20px 28px">
