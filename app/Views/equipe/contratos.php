...
document.addEventListener('DOMContentLoaded', function() {
  ...
  linhas.forEach(linha => {
    const link = linha.querySelector('a[href*="/equipe/contratos/"]');
    if (!link) return;
    ...
    btnExcluir.onclick = (e) => excluirContrato(id, e);
