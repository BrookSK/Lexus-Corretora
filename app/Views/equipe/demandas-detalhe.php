...
<div class="section-header">
  ...
  <div style="display:flex;gap:8px">
    <?php 
    // Verificar se existe PDF finalizado
    $pdfFinalizado = !empty($demanda['pdf_finalized_at']);
    ?>
    
    <?php if ($pdfFinalizado): ?>
    <a href="/equipe/demandas/<?php echo (int)$demanda['id']; ?>/pdf/download" target="_blank" class="btn btn-success" style="display:flex;align-items:center;gap:6px">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
        <polyline points="7 10 12 15 17 10"/>
        <line x1="12" y1="15" x2="12" y2="3"/>
      </svg>
      ⬇ Download PDF Finalizado
    </a>
    <span style="font-size:.75rem;color:var(--success);display:flex;align-items:center;padding:0 8px">
      ✓ Finalizado em <?php echo date('d/m/Y H:i', strtotime($demanda['pdf_finalized_at'])); ?>
    </span>
    <?php endif; ?>
    
    <a href="/equipe/demandas/<?php echo (int)$demanda['id']; ?>/apresentacao" class="btn btn-primary" style="display:flex;align-items:center;gap:6px">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <?php echo $pdfFinalizado ? '✏️ Editar PDF' : '📄 Criar Apresentação PDF'; ?>
    </a>
