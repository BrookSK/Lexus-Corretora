  ...
  <form method="POST" action="/equipe/clientes/<?php echo (int)$cliente['id']; ?>/editar">
    ...
    <div class="form-row" style="margin-top:8px">
      <div class="form-group">
        ...
        <input type="password" name="password" id="cliente_password" autocomplete="new-password" placeholder="Deixe em branco para não alterar"/>
      </div>
      <div class="form-group">
        <label><?php echo View::e(I18n::t('auth.confirmar_senha')); ?></label>
        <input type="password" id="cliente_password_confirm" autocomplete="new-password" placeholder="Repita a nova senha"/>
      </div>
    </div>
...
(function(){
  document.querySelector('form[action*="/editar"]').addEventListener('submit', function(e){
    var p = document.getElementById('cliente_password');
    var c = document.getElementById('cliente_password_confirm');
