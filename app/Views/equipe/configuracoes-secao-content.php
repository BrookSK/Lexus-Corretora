...
<?php elseif ($secao === 'seguranca'): ?>
  <div class="form-group">
    ...
    <input type="number" name="seguranca.senha_min" value="<?php echo View::e((string)($settings['seguranca.senha_min'] ?? '8')); ?>" min="6" max="32"/>
  </div>
  <div class="form-group">
    <label>Sessão expira em (minutos)</label>
    <input type="number" name="seguranca.sessao_expira" value="<?php echo View::e((string)($settings['seguranca.sessao_expira'] ?? '1440')); ?>" min="30"/>
  </div>
  <div class="form-group">
