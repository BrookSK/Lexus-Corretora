...
<div class="section">
<div class="section-title">— Descrição Profissional do Projeto</div>
...
⚠️ TEXTO REFORMATADO POR IA — Baseado exclusivamente nas informações originais fornecidas pelo cliente
</div>
<div class="text-block"><?php echo nl2br(View::e($descricaoFormal)); ?></div>
</div>
<?php endif; ?>

<?php if (!empty($demanda['description'])): ?>
<div class="section">
<div class="section-title">— Descrição Original do Cliente</div>
<div class="text-block"><?php echo nl2br(View::e($demanda['description'])); ?></div>
</div>
<?php endif; ?>
...
<div class="text-block"><?php echo nl2br(View::e($demanda['notes'])); ?></div>
</div>
<?php endif; ?>
