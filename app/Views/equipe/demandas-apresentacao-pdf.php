...
<style>
:root{--gold:#C9A96E;--gold-light:#E8C98A;--gold-dark:#9A7A48;--black:#0A0A0A;--dark:#111111;--dark-card:#161616;--off-white:#F5F2EC;--muted:#7A7570;--border:rgba(201,169,110,0.18);--border-light:rgba(201,169,110,0.08)}*{margin:0;padding:0;box-sizing:border-box}@page{size:A4;margin:0;background:#0A0A0A}html{background:#0A0A0A}body{font-family:'Jost',sans-serif;background:#0A0A0A;color:var(--off-white);width:210mm;margin:0 auto;font-size:14.4px;line-height:1.5;position:relative;min-height:100vh}body::before{content:'';position:fixed;top:50%;left:50%;width:150%;height:150%;background-image:url('<?php echo !empty($logoSistema) ? View::e($logoSistema) : ""; ?>');background-repeat:repeat;background-size:400px;background-position:center;opacity:0.02;transform:translate(-50%,-50%) rotate(-45deg);z-index:0;pointer-events:none}.page-wrapper{background:#0A0A0A;min-height:100vh;position:relative;z-index:1}.header{background:var(--black);padding:16px 30px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;position:relative;z-index:1}.header::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,var(--gold),var(--gold-light),var(--gold),transparent)}.header-left{display:flex;align-items:center;gap:16px}.logo-img{max-height:40px;max-width:120px;object-fit:contain}.logo-wordmark{font-family:'Cormorant Garamond',serif;font-size:25.6px;font-weight:400;letter-spacing:3px;color:var(--gold);text-transform:uppercase}.logo-tagline{font-size:10.4px;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-top:2px}.doc-id{font-family:'Cormorant Garamond',serif;font-size:28.8px;font-weight:300;color:var(--off-white);letter-spacing:1px}.doc-id span{color:var(--gold)}.doc-date{font-size:10.4px;color:var(--muted);letter-spacing:1.5px;text-transform:uppercase;margin-top:3px;text-align:right}.hero{background:linear-gradient(135deg,#0D0B08 0%,#161410 50%,#0D0B08 100%);padding:16px 30px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;position:relative;z-index:1}.hero-title{font-family:'Cormorant Garamond',serif;font-size:38.4px;font-weight:300;line-height:1.1;color:var(--off-white)}.hero-label{font-size:9.6px;letter-spacing:2.5px;text-transform:uppercase;color:var(--gold);margin-bottom:5px}.hero-client{font-size:12px;color:var(--muted);margin-top:6px;letter-spacing:0.8px}.status-badge{background:rgba(201,169,110,0.08);border:1px solid var(--border);border-radius:2px;padding:6px 14px;text-align:center}.status-label{font-size:8.8px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-bottom:4px}.status-value{font-family:'Cormorant Garamond',serif;font-size:20.8px;font-weight:400;color:var(--gold);letter-spacing:1.5px;text-transform:uppercase}.content{padding:20px 30px;background:var(--dark);position:relative;z-index:1}.section{margin-bottom:16px;page-break-inside:avoid;position:relative;z-index:1}.section-title{font-size:9.6px;letter-spacing:2.5px;text-transform:uppercase;color:var(--gold);margin-bottom:8px;padding-bottom:4px;border-bottom:1px solid var(--border)}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:12px}.grid-2{grid-template-columns:repeat(2,1fr)}.grid-4{grid-template-columns:repeat(4,1fr)}.info-box{background:var(--dark-card);border:1px solid var(--border-light);padding:10px 12px}.info-label{font-size:9.6px;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:4px}.info-value{font-size:13.6px;color:var(--off-white);font-weight:400;word-break:break-word}.info-value.highlight{color:var(--gold);font-weight:500}.text-block{background:var(--dark-card);border:1px solid var(--border-light);padding:12px 14px;white-space:pre-wrap;font-size:12.8px;line-height:1.6;color:rgba(245,242,236,0.85)}.photos-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.photo-card{background:var(--dark-card);border:1px solid var(--border-light);overflow:hidden;page-break-inside:avoid;display:flex;flex-direction:column}.photo-img{width:100%;height:auto;object-fit:contain;display:block;max-height:400px;background:var(--dark-card)}.photo-placeholder{height:200px;background:linear-gradient(135deg,#1a1814,#201e1a);display:flex;align-items:center;justify-content:center;color:var(--gold-dark);font-size:18px;opacity:0.5}.photo-caption{padding:8px 10px;font-size:11.2px;color:rgba(245,242,236,0.7);line-height:1.4;border-top:1px solid var(--border-light);background:rgba(0,0,0,0.3)}.timeline{position:relative;padding-left:18px}.timeline::before{content:'';position:absolute;left:5px;top:5px;bottom:5px;width:1px;background:linear-gradient(to bottom,var(--gold-dark),transparent)}.timeline-item{position:relative;margin-bottom:10px;padding-bottom:10px;border-bottom:1px solid rgba(255,255,255,0.03)}.timeline-item:last-child{border-bottom:none;margin-bottom:0}.timeline-dot{position:absolute;left:-15px;top:3px;width:5px;height:5px;border:1px solid var(--gold-dark);background:var(--dark);transform:rotate(45deg)}.timeline-date{font-size:9.6px;color:var(--gold-dark);letter-spacing:1.2px;margin-bottom:2px;text-transform:uppercase}.timeline-event{font-size:12px;color:var(--off-white);font-weight:400}.timeline-actor{font-size:9.6px;color:var(--muted);margin-top:1px}.footer{background:var(--black);border-top:1px solid var(--border);padding:14px 30px;display:flex;justify-content:space-between;align-items:center;font-size:9.6px;color:var(--muted);position:relative;z-index:1}.footer-brand{font-family:'Cormorant Garamond',serif;font-size:16px;letter-spacing:3px;color:var(--gold);text-transform:uppercase}.print-btn{position:fixed;bottom:20px;right:20px;background:var(--gold);color:var(--black);border:none;padding:12px 24px;font-family:'Jost',sans-serif;font-size:17.6px;letter-spacing:1.5px;text-transform:uppercase;cursor:pointer;font-weight:600;z-index:1000;transition:all 0.3s;border-radius:4px;box-shadow:0 4px 12px rgba(201,169,110,0.4)}.print-btn:hover{background:var(--gold-light);transform:translateY(-2px);box-shadow:0 6px 16px rgba(201,169,110,0.6)}.print-btn:active{transform:translateY(0)}.toolbar{position:fixed;top:0;left:0;right:0;background:rgba(10,10,10,0.95);backdrop-filter:blur(10px);padding:12px 30px;display:flex;justify-content:space-between;align-items:center;z-index:999;border-bottom:1px solid var(--border)}.toolbar-title{font-family:'Cormorant Garamond',serif;font-size:22.4px;color:var(--gold);letter-spacing:2px}.toolbar-btn{background:var(--gold);color:var(--black);border:none;padding:8px 20px;font-family:'Jost',sans-serif;font-size:16px;letter-spacing:1.2px;text-transform:uppercase;cursor:pointer;font-weight:600;border-radius:3px;transition:all 0.2s;margin-left:10px}.toolbar-btn:hover{background:var(--gold-light);transform:scale(1.05)}.toolbar-btn.secondary{background:transparent;border:1px solid var(--gold);color:var(--gold)}.toolbar-btn.secondary:hover{background:rgba(201,169,110,0.1)}body{margin-top:60px}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact;margin-top:0;background:#0A0A0A !important}body::before{opacity:0.015 !important}@page{background:#0A0A0A;margin:0}.print-btn,.toolbar{display:none}.header,.hero,.content,.section,.footer{page-break-inside:avoid}.header{background:#0A0A0A !important;border-bottom:1px solid rgba(201,169,110,0.18) !important;page-break-after:avoid}.hero{background:#0D0B08 !important;page-break-after:avoid;page-break-before:avoid}.content{background:#111111 !important;page-break-before:avoid}.section{background:transparent !important;page-break-before:auto}.section:first-child{page-break-before:avoid}.info-box,.text-block,.photo-card{background:#161616 !important;border:1px solid rgba(201,169,110,0.08) !important}.grid,.grid-2,.grid-4{page-break-inside:avoid}.footer{background:#0A0A0A !important;border-top:1px solid rgba(201,169,110,0.18) !important}}
</style>
</head>
<body>
...
<img src="<?php echo View::e($logoSistema); ?>" alt="<?php echo View::e($nomeSistema); ?>" class="logo-img">
<?php else: ?>
<div><div class="logo-wordmark"><?php echo View::e($nomeSistema); ?></div><div class="logo-tagline">Estruturação Estratégica de Obras</div></div>
<?php endif; ?>
</div>
