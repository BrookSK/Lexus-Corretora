...
<title><?php echo View::e(I18n::t('auth.entrar')); ?> — <?php echo \LEX\Core\View::e(\LEX\Core\SistemaConfig::nome()); ?> Equipe</title>
...
<div class="auth-page">
  <div class="auth-box">
    ...
    <h2 class="auth-title"><?php echo View::e(I18n::t('auth.entrar')); ?> — Equipe</h2>
