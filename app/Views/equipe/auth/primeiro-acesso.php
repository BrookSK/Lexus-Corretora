...
<title><?php echo View::e(I18n::t('auth.primeiro_acesso')); ?> — <?php echo \LEX\Core\View::e(\LEX\Core\SistemaConfig::nome()); ?></title>
...
<div class="auth-page">
  <div class="auth-box">
    ...
    <h2 class="auth-title"><?php echo View::e(I18n::t('auth.criar_superadmin')); ?></h2>
    ...
    <form method="POST" action="/equipe/primeiro-acesso">
      ...
      <button type="submit" class="btn btn-primary" style="width:100%"><?php echo View::e(I18n::t('geral.criar')); ?></button>
    </form>
  </div>
</div>
</body></html>
